...
while True:
    try:
        ...
        tweet1 = "The Latest Coronavirus statistics from the US ⚠️ are as follows: \n Confirmed: " + str(confirmed) + "" + "\n Deaths: " + str(deaths) + "" + "\n Reliable data from https://covid19.mathdro.id/api/countries/USA" "\n #COVID19 #COVID-19 #Covid_19 #Coronavirus #CoronavirusPandemic #USA #staysafe"
        print(tweet1)        
